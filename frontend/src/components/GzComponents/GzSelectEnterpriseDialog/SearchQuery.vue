<template>
	<div class="search-q">
		<el-form class="gz-form-search" :model="queryParams" ref="queryRef" :inline="true">
			...
			<el-form-item label="企业身份" prop="supplySource">
				<el-select
			...
			<el-form-item label="搜索" prop="name">
				<el-input v-model="queryParams.name" placeholder="企业名称" clearable style="width: 160px" />
			</el-form-item>
...
<script setup>
import { ref, reactive, toRefs, watch, onBeforeMount, getCurrentInstance, defineAsyncComponent } from 'vue';
