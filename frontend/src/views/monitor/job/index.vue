<template>
	<div class="app-container">
		...
		<el-row :gutter="10" class="mb8">
			...
			<el-col :span="1.5">
				<el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate" v-hasPermi="['monitor:job:edit']"
					>修改</el-button
				>
			</el-col>
			<el-col :span="1.5">
									...
									<el-tooltip placement="top">
										<template #content>
											<div>
												...
												<br />Class类调用示例：com.aaaaa.quartz.task.RyTask.ryParams('ry')
