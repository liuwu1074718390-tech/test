<template>
	<div class="app-container">
		...
		<el-row :gutter="10" class="mb8">
			...
			<el-col :span="1.5">
				<el-button type="success" plain icon="Edit" :disabled="single" @click="handleEditTable" v-hasPermi="['tool:gen:edit']"
					>修改</el-button
				>
			</el-col>
			<el-col :span="1.5">
...
function handleGenTable(row) {
	...
	if (row.genType === '1') {
		...
		proxy.$download.zip('/tool/gen/batchGenCode?tables=' + tbNames, 'gz.zip');
	}
}
/** 同步数据库操作 */
