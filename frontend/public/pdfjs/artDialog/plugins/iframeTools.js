...
eval(
	(function (B, D, A, G, E, F) {
		function C(A) {
			return A < 62
				? String.fromCharCode((A += A < 26 ? 65 : A < 52 ? 71 : -4))
				: A < 63
					? '_'
					: A < 64
						? '$'
