				...
				function (a) {
					...
					return g !== n && 9 === g.nodeType && g.documentElement
						? ((n = g),
							...
							e &&
								e !== e.top &&
								(e.addEventListener ? e.addEventListener('unload', ea, !1) : e.attachEvent && e.attachEvent('onunload', ea)),
							(p = !f(g)),
			...
			filter: function (a, b) {
				...
				return (
					null == a.pageX &&
						...
						(c = d.body),
						(a.pageX =
							b.clientX + ((e && e.scrollLeft) || (c && c.scrollLeft) || 0) - ((e && e.clientLeft) || (c && c.clientLeft) || 0)),
						(a.pageY =
			...
			return this instanceof m.Event
				? (a && a.type
						? ((this.originalEvent = a),
							(this.type = a.type),
							(this.isDefaultPrevented = a.defaultPrevented || (void 0 === a.defaultPrevented && a.returnValue === !1) ? aa : ba))
						: (this.type = a),
					b && m.extend(this, b),
	...
	m.extend({
		...
		m.fn.extend({
			...
			domManip: function (a, b) {
				...
				if (
					l &&
					((i = m.buildFragment(a, this[0].ownerDocument, !1, this)), (c = i.firstChild), 1 === i.childNodes.length && (i = c), c)
				) {
	...
	function ib(a, b, c) {
		...
		c.queue ||
			...
			1 === a.nodeType &&
				...
				'inline' === l &&
					'none' === m.css(a, 'float') &&
					(k.inlineBlockNeedsLayout && 'inline' !== Fa(a.nodeName) ? (p.zoom = 1) : (p.display = 'inline-block'))),
			c.overflow &&
				((p.overflow = 'hidden'),
				k.shrinkWrapBlocks() ||
					n.always(function () {
	...
	m.extend({
			...
			if (
				...
				null == k.crossDomain &&
					...
					(k.crossDomain = !(
						...
						(c[1] === yb[1] &&
							c[2] === yb[2] &&
							(c[3] || ('http:' === c[1] ? '80' : '443')) === (yb[3] || ('http:' === yb[1] ? '80' : '443')))
					))),
		...
		m.each(['get', 'post'], function (a, b) {
			m[b] = function (a, c, d, e) {
				return (
					m.isFunction(c) && ((e = e || d), (d = c), (c = void 0)), m.ajax({ url: a, type: b, dataType: e, data: c, success: d })
				);
			};
		}),
