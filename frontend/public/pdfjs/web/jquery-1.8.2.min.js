	...
	p.fn.extend({
		...
		(M = {
			...
			set: function (a, b, c) {
				var d;
				return (
					b === !1 ? p.removeAttr(a, c) : ((d = p.propFix[c] || c), d in a && (a[d] = !0), a.setAttribute(c, c.toLowerCase())), c
				);
			}
		}),
		U ||
			...
			filter: function (a, c) {
				...
				return (
					a.pageX == null &&
						...
						(g = d.body),
						(a.pageX =
							c.clientX + ((f && f.scrollLeft) || (g && g.scrollLeft) || 0) - ((f && f.clientLeft) || (g && g.clientLeft) || 0)),
						(a.pageY =
							c.clientY + ((f && f.scrollTop) || (g && g.scrollTop) || 0) - ((f && f.clientTop) || (g && g.clientTop) || 0))),
				...
				r.querySelectorAll &&
					(function () {
						var a,
							...
							f = [':active', ':focus'],
							h =
								s.matchesSelector || s.mozMatchesSelector || s.webkitMatchesSelector || s.oMatchesSelector || s.msMatchesSelector;
						X(function (a) {
	...
	p.fn.extend({
		...
		p.extend({
			filter: function (a, b, c) {
				return (
					c && (a = ':not(' + a + ')'), b.length === 1 ? (p.find.matchesSelector(b[0], a) ? [b[0]] : []) : p.find.matches(a, b)
				);
			},
			dir: function (a, c, d) {
				var e = [],
					...
					if (typeof h == 'string')
						if (!br.test(h)) h = b.createTextNode(h);
							...
							if (!p.support.tbody) {
								(m = bq.test(h)),
									(n =
										i === 'table' && !m ? l.firstChild && l.firstChild.childNodes : j[1] === '<table>' && !m ? l.childNodes : []);
				...
				for (; (e = a[g]) != null; g++)
					if (b || p.acceptData(e)) {
						...
						if (c) {
							...
							i[d] &&
								(delete i[d], j ? delete e[h] : e.removeAttribute ? e.removeAttribute(h) : (e[h] = null), p.deletedIds.push(d));
						}
					}
			}
		}),
